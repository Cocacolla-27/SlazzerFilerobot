...
const FooterToolbarBox = styled('div')`
  display: flex;
  float: right
`;

const FooterToolbarMiddleBox = styled.div`
  display: flex;
`;
...
export { Footer, PreviousBtn, NextBtn, ResetBtn, FullscreenBtn, FooterToolbarBox,FooterToolbarMiddleBox, Switcher };
